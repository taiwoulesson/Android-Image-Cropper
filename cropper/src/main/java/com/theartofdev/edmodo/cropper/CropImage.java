...
public final class CropImage {
     ...
     *                activity/fragment/widget.
     */
    public static Intent getPickImageChooserIntent(@NonNull Context context, @NonNull CropImageOptions.PictureSource source) {
        return getPickImageChooserIntent(
                context, source, context.getString(R.string.pick_image_intent_chooser_title), false, true);
    }
    ...
    public static Intent getPickImageChooserIntent(
        ...
        if (source == CropImageOptions.PictureSource.CAMERA) {
            ...
            allIntents.addAll(galleryIntents);
        } else if (source == CropImageOptions.PictureSource.CAMERA_GALLERY) {
            allIntents.addAll(getCameraIntents(context, packageManager));
            allIntents.addAll(galleryIntents);
        } else {
            allIntents.addAll(getCameraIntents(context, packageManager));
    ...
    public static final class ActivityBuilder {
        ...
        /**
         * select if camera of all gallery<br>
         * <i>Default: camera</i>
         */
        public ActivityBuilder from(CropImageOptions.PictureSource source) {
